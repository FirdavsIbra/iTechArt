...
namespace iTechArt.Data.Migrations
{
    ...
    [Migration("20221011204248_medStaff")]
    partial class medStaff
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iTechArt.Domain.Entities.MedicalStaff.Patient", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("iTechArt.Domain.Entities.MedicalStaff.PatientDoctor", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("iTechArt.Domain.Entities.MedicalStaff.StaffHospitalContraction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("StaffHospitalContractions");
                });
            ...
            modelBuilder.Entity("iTechArt.Domain.Entities.MedicalStaff.Hospital", b =>
                {
                    b.HasOne("iTechArt.Domain.Entities.MedicalStaff.Location", "Address")
                        .WithMany()
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("iTechArt.Domain.Entities.MedicalStaff.PatientDoctor", b =>
                {
                    b.HasOne("iTechArt.Domain.Entities.MedicalStaff.Staff", "Staff")
                        .WithMany()
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("iTechArt.Domain.Entities.MedicalStaff.Patient", "Patient")
                        .WithMany()
            ...
            modelBuilder.Entity("iTechArt.Domain.Entities.MedicalStaff.Staff", b =>
                {
                    b.HasOne("iTechArt.Domain.Entities.MedicalStaff.Location", "Address")
                        .WithOne()
                        .HasForeignKey("iTechArt.Domain.Entities.MedicalStaff.Staff", "AddressId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("iTechArt.Domain.Entities.MedicalStaff.StaffHospitalContraction", b =>
                {
                    b.HasOne("iTechArt.Domain.Entities.MedicalStaff.Hospital", "Hospital")
                        .WithMany()
